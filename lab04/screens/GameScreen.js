...
const GameScreen = (props) => {
  ...
  if (confirmed) {
    ...
    confirmedOutput = (
      <View style={styles.resultContainer}>
        ...
        <Text>{selectedNumber==props.answer ? props.onGameOver(rounds) : selectedNumber>props.answer ? "The answer is lower." : "The answer is greater."} Round : {rounds}</Text>
      </View>
    );
  }
  ...
  //   ...เพิ่มโค้ด อัพเดทค่าในสเตทต่างๆ ตามที่กำหนด
    ...
    console.log("select : ", selectedNumber)
